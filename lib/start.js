...
start.usage = "fhc start <app-id> [--env=<environment>]";
...
function startApp(appId, deployTarget, cb) {
  common.doApiCall(fhreq.getFeedHenryUrl(), "box/srv/1.1/ide/" + fhc.target + "/app/start", {guid: appId, deploytarget: deployTarget}, "Error starting app: ", function(err, data) {
