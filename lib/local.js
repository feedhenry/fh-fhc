...
local.usage = ["",
               ...
               "",
               " fhc local <appID>* <cloudHost=host> <cloudPort=port>  <port=port>  <logprefix=true|false>  <loghighlight=true|false>",
               ...
               " where <logprefix> is a boolean indicator as to whether stdout and stderr messages should be prefixed ",
               "       with their log types - 'CLOUD stdout:' and 'CLOUD stderr:' - respectively (default : false). ",
               " where <loghighlight> is a boolean indicator as to whether stdout and stderr messages should be ",
               "       output in green or red text respectively (default : true). ",
               ""
              ].join("\n");
