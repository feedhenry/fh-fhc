...
StaticHandler.prototype.buildIndex = function(file, requestQuery) {
  ...
  if(requestQuery.device !== undefined && requestQuery.version !== undefined) {
    ...
    sdkScript.setAttribute("src", "https://raw.github.com/feedhenry/fh-js-sdk/master/feedhenry.js");
    apiScript.setAttribute("src", "https://" + this.target + "/static/pec/script/studio/155-scripts.js");
  }

  sdkInitScript.append('var config = {host: "http://127.0.0.1:8888",appid: "localguidplaceholder",appkey: "localappkeyplaceholder",mode: "dev"};');
  ...
  head.append(contentType, sdkScript, sdkInitScript);
  body.append(file);
