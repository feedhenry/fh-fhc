...
local.usage = ["",
               ...
               "   port : the port that serves your client content. Default value is 8000. ",
               "   cloudHost : the ip address or hostname used for serving the cloud code. Default value is http://127.0.0.1. Specify the ip address or the host name of the server if you want to test from a mobile device.",
               ...
               " Examples : ",
               "   fhc local port=9000 cloudHost=http://192.168.28.34 cloudPort=9001",
