...
local.usage = ["",
               ...
               "   openClient : indicates whether the client URL (typically http://127.0.0.1:8000) should be opened in the default browser when fhc local starts. Default value is true.",
               " Examples : ",
