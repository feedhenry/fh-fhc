...
users.usage = "\nfhc admin-users list"
             +"\nfhc admin-users create username=<username> [password=<password>] [email=<email>] [name=<name>] [roles=<roles>] [groups=<groups>] [invite=<invitation>]"
             +"\nfhc admin-users delete <username>"
             +"\nfhc admin-users read <username>"
             +"\nfhc admin-users update username=<username> [password=<password>] [email=<email>] [name=<name>] [roles=<roles>] [groups=<groups>] [inviation=<invitation>] [enabled=<enabled>]"
             +"\nfhc admin-users enable <username>"
             +"\nfhc admin-users disable <username>"
             +"\nfhc admin-users changeroles <username> <roles>"
             +"\nfhc admin-users changegroups <username> <groups>"
...
users.completion = function (opts, cb) {
  ...
  if (argv.length === 2) {
    var cmds = ["list", "read", "create", "update", "delete", "enable", "disable", "changeroles", "changegroups", "listdevices", "listinstallapps"];
