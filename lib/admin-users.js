...
function users (args, cb) {
  ...
  //   if(args.length < 2) return cb(users.usage);
  //   var act = args.shift();
  //   var username = args.shift();
  //   return addgroups(username, args, cb);
  // }else if (action === 'removegroups'){
  //   if(args.length < 2) return cb(users.usage);
  //   var act = args.shift();
  //   var username = args.shift();
  //   return removegroups(username, args, cb);
...
// function addgroups(username, groups, cb) {
//   common.doApiCall(fhreq.getFeedHenryUrl(), "/box/srv/1.1/admin/user/addgroups", {"username": username,  "groups": groups}, "Error adding groups to user: ", function(err, data){
//     if(err) return cb(err);
//     return cb(undefined, data);
//   });
// }

// function removegroups(username, groups, cb) {
//   common.doApiCall(fhreq.getFeedHenryUrl(), "/box/srv/1.1/admin/user/removegroups", {"username": username,  "groups": groups}, "Error removing groups from user: ", function(err, data){
//     if(err) return cb(err);
//     return cb(undefined, data);
//   });
// }
