...
deployTargets.usage = "\nfhc deploy-target create name=<the name of the deploy target> platform=<feedhenry/cloudfoundry/stackato/appfog/ironfoundry> env=<dev/live/all> conf_url=<deploy url> conf_username=<user for the deploy> conf_password=<user password for the deploy> [conf_infrastructure=<infrastructure providers>] ..."
