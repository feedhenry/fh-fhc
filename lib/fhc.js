...
if (require.main === module) {
  console.error([
    ...
    "Don't do that. Instead, run 'node bin/fh.js'",
    "and then use the 'fh' command line utility."
  ].join("\n"));
  process.exit(1);
}
...
fhc.applyCommandFunction = function(processArgv, cb){
  ...
  /*
    ...
    Nesessary to delay before calling this as bin/fh relies on properties appended
