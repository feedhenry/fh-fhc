...
fhc.appId = function (appid) {
  //if its undefined return it back so flow continues as normal
    if(!appid) return appid;
    //appid or guits are 24 chars and an alias can be no longer than 23
   if(appid.length === 24) return appid;
