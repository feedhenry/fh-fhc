...
function listKeys(args, cb){
  var url = 'box/srv/1.1/ide/testing/api/list';
...
function addKey(args, cb){
  ...
  var label = args[1];
  var url = 'box/srv/1.1/ide/testing/api/create';
  var payload = {
    "type":"user",
    "label": label,
    "fields":{
...
function updateKey(args, cb) {
  ...
  readKey(['read', oldLabel], function(err, key) {
    ...
    var url = "box/srv/1.1/ide/testing/api/update";
...
function deleteKey(args, cb) {
  ...
  readKey(['read', label], function(err, key) {
    ...
    var url = "box/srv/1.1/ide/testing/api/delete";
    var payload = {"key": key.key};
