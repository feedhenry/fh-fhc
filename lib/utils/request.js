...
function doRequest(fhurl, method, where, what, etag, nofollow, cb_, auth_) {
...
function POSTAUTH(url, where, what, auth, etag, nofollow, cb) {
  request.requestFunc(url, "POST", where, what, etag, nofollow, cb, auth);
}
