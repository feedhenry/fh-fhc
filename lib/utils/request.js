...
request.formsImportZipFileUpload = formsImportZipFileUpload;
...
/**
 * Upload function for the appforms/forms/import command
 ...
 */
function formsImportZipFileUpload(path, url, cb) {
  ...
  requestjs.post(opts, _uploadHandlerFor(cb));
}
...
function streamFileUpload(params, cb){
  ...
  requestjs(opts, _uploadHandlerFor(cb));
}
