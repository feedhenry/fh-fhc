...
request.requestStream = doRequestWithStream;
...
function doRequest (fhurl, method, where, what, etag, nofollow, cb_) {
  return doRequestImpl(fhurl, method, where, what, etag, nofollow, false, cb_);
}

function doRequestWithStream(fhurl, method, where, what, etag, nofollow, cb_) {
  return doRequestImpl(fhurl, method, where, what, etag, nofollow, true, cb_);
}

function doRequestImpl (fhurl, method, where, what, etag, nofollow, doStream, cb_) {
