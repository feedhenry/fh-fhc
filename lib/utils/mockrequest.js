...
function mockRequest (fhurl, method, where, what, etag, nofollow, cb_) {
  ...
  if (where == 'box/srv/1.1/ide/apps/app/list') {
    ...
    data = mockCacheKeys;
  }else if(where == "box/srv/1.1/ide/apps/api/list"){
    data = mockKeyList;
  }else if(where == "box/srv/1.1/ide/apps/api/create"){
    data = mockKeyCreate;
  }else if(where == "box/srv/1.1/ide/apps/api/revoke"){
    data = mockKeyRevoked;
  }else if(where == "box/srv/1.1/ide/apps/api/update"){
    data = mockKeyUpdated;
  }
  else {
