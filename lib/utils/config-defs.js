...
Object.defineProperty(exports, "defaults", {get: function () {
  ...
  return defaults =
    ...
    , usesysinspect : false
    , username : ""
    , userconfig : process.platform === "win32" ? path.resolve( process.env.HomePath, "fhc-config" ) : path.resolve(process.env.HOME, ".fhcrc")
    , usertargets : process.platform === "win32" ?  path.resolve( process.env.HomePath ,"fhc-targets") : path.resolve(process.env.HOME, ".fhctargets")
    , version : false
    , viewer: "man"
    , _exit : true
    };
