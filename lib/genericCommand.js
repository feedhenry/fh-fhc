...
var async = require('async'),
  ...
  fhc = require('./fhc'),
  request = require('request'),  // don't set proxy or other configured defaults here, since the config may not be loaded when this module is
  path = require('path'),
