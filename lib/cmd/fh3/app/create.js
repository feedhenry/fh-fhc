...
module.exports = {
  ...
  'examples': [
    {
      ...
      desc: "Creates a new hybrid app from template"
    },
    {
      cmd: "fhc app create --project=1a2b3c --title=My New App --repo=git:///some.com/repo.git --branch=master",
      desc: "Creates a new hybrid app from a git repo"
    },
    {
      cmd: "fhc app create --project=1a2b3c --title=My New App --type=cloud_nodejs --empty=true",
      desc: "Creates an empty node.js app repo into which code can be pushed"
    }
  ],
  ...
  'describe': {
    ...
    'empty' : 'Creates an empty git repository into which users can push',
    ...
    'type' : 'Type of app to create - e.g. cloud_nodejs, client_hybrid'
  },
  'defaults': {
