...
module.exports = { 
  ...
  'examples' : [
    {cmd : "fh app create --project=1a2b3c --title=My New App --type=cloud_nodejs", desc : "Creates a new hybrid app from template" },
    {cmd : "fh app create --project=1a2b3c --title=My New App --repo=git:///some.com/repo.git --branch=master", desc : "Creates a new hybrid app from a git repo" }
  ],
  ...
  'describe' : {
    ...
    'template' : 'Template of your app - e.g. hello_world_mbaas_instance. See fh templates apps',
