...
connections.usage = "fh connections [list] <project-id>\n" +
                  "fh connections read <project-id> <connection-id>\n" +
                  "fh connections update <proejct-id> <connection-id> <cloud-app-id> --env=<environment>\n";
