...
services.usage = "fh services [list]"
    + "\nfh services create <service-title> [<template-id>]"
    + "\nfh services update <service-id> <prop-name> <value>"
    + "\nfh services read <service-id>"
    + "\nfh services delete <service-id>"
