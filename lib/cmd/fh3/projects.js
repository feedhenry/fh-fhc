...
projects.desc = "Manage projects";
projects.usage = "fh projects [list]" +
    "\nfh projects create <project-title> [<template-id>]" +
    "\nfh projects update <project-id> <prop-name> <value>" +
    "\nfh projects read <project-id>" +
    "\nfh projects delete <project-id>" +
    "\nfh projects clone <project-id>" +
