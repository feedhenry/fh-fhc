module.exports = { 
  ...
  'examples' : [{ cmd : 'fh admin mbaas update --id=<mBaaS id> --url=<mBaaS URL> --servicekey=<mBaaS Service Key> --username=<mBaaS User Name> --password=<mBaaS Password>', desc : 'Updates an environment with id <mbaasId>'}],
  'demand' : ['id'],
  'alias' : {},
  'describe' : {
