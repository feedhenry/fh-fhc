module.exports = { 
  ...
  'examples' : [{ cmd : 'fh admin mbaas create --id=<mBaaS id> --url=<mBaaS URL> --servicekey=<mBaaS Service Key> --username=<mBaaS User Name> --password=<mBaaS Password>', desc : 'Creates an environment'}],
