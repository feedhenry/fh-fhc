module.exports = { 
  ...
  'examples' : [{ cmd : 'fhc admin environments update --id=<environment id> --label=<label> --targets=<mbaasTargetId1>,<mbaasTargetId2> --autoDeployOnCreate=false --autoDeployOnUpdate=false', desc : 'Update an environment by id'}],
  'demand' : ['id'],
  'alias' : {},
  'describe' : {
