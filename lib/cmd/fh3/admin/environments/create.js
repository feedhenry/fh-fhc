module.exports = { 
  ...
  'examples' : [{ cmd : 'fhc admin environments create --id=<environment id> --label=<label> --targets=<mbaasTargetId1>,<mbaasTargetId2> --autoDeployOnCreate=false --autoDeployOnUpdate=false', desc : 'Creates an environment'}],
