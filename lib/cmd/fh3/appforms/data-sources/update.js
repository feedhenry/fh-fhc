...
module.exports = {
  ...
  'examples': [{cmd: 'fhc appforms data-sources update --id="dataSource123456" --name="New Data Source" --description="A Data Source" --refreshInterval=2 --serviceGuid="glaovni73qwjla5qt2oyocw3" --endpoint="/path/to/data" --numAuditLogEntries 20', desc: 'Update a data source.'}],
  'demand': ['id'],
  'alias': {},
  'describe': {
