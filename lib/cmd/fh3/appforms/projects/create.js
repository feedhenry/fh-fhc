...
module.exports = {
  ...
  'examples' : [{ cmd : 'fhc appforms projects create --id=<GUID Of Project To Associate With Forms> --theme=<ID Of Theme To Associate With The Project> --forms=<formId1>,<formId2>', desc : 'Create A Single Form Project'}],
