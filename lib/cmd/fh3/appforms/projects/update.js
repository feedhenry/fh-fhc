...
module.exports = {
  ...
  'examples' : [{ cmd : 'fhc appforms apps update --id=<GUID Of Form Project To Update> --theme=<ID Of Theme To Associate With The Project> --forms=<formId1>,<formId2>', desc : 'Update A Single Form Project'}],
  'demand' : ['id'],
  'alias' : {},
  'describe' : {
