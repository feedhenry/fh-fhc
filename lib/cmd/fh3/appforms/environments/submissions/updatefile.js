...
module.exports = {
  ...
  'examples' : [{ cmd : 'fhc appforms environments submissions updatefile --environment=<ID Of Environment The Submission Is Located In> --id=<Submission ID> --fieldid=<ID Of Field The File Is Being Updated To>--fileid=<ID Of File To Update> --file=<Path To File To Upload>', desc : 'Update A Single File In A Submission'}],
