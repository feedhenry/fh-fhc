...
module.exports = {
  ...
  'examples' : [{ cmd : 'fhc appforms environments submissions exportpdf --environment=<ID Of Environment The Submission Is Located In> --id=<Submission ID> --output=<File To Download Submission To>.pdf', desc : 'Export A Single Submission As A PDF File'}],
  ...
  'customCmd': function(params, cb){
    ...
    fs.exists(params.output, function(exists){
      if(exists){
