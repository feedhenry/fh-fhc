...
module.exports = {
  ...
  'examples' : [{ cmd : 'fhc appforms environments forms promote --id=<ID Of Form To Promote> --from=<ID Of Environment To Promote From> --to=<ID Of Environment To Promote To>', desc : 'Promote A Form From One Environment To Another'}],
  'demand' : ['from', 'to', 'id'],
  'alias' : {},
  'describe' : {
