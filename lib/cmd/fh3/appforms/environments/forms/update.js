...
module.exports = {
  ...
  'examples' : [{ cmd : 'fhc appforms environments forms update --id=<ID Of Form To Update> --environment=<ID Of Environment To Update Form> --formfile=<Path To Form JSON File>', desc : 'Update A Single Form Deployed To An Environment'}],
