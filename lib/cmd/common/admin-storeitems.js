...
storeitems.usage = "\nfh admin-storeitems list"
  +"\nfh admin-storeitems create <name> [description=<description>] [authToken=<authToken>] [restrictToGroups=<restrictToGroups>]"
  +"\nfh admin-storeitems delete <storeitem guid>"
  +"\nfh admin-storeitems read <storeitem guid>"
  +"\nfh admin-storeitems update <storeitem guid> <name> <description> <authToken>  [<restrictToGroups>]"
  +"\nfh admin-storeitens uploadicon <storeitem guid> <path to icon>"
  +"\nfh admin-storeitems uploadbinary <storeitem guid> <type iphone|android|ipad> <path to app binary>"
  +"\nfh admin-storeitems addpolicy <storeitem guid> <policy_guid>"
  +"\nfh admin-storeitems removepolicy <storeitem guid> <policy_guid>"
  +"\nfh admin-storeitems listpolicies <storeitem guid>"
  +"\nfh admin-storeitems grouprestrict <storeitem guid> <true|false>"
  +"\nfh admin-storeitems addgroups <storeitem guid> <group_guid>*"
  +"\nfh admin-storeitems removegroups <storeitem guid> <group_guid>*" +
  "\nfh admin-storeitems binaryversions <storeiten guid> ";
