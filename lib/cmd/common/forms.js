...
forms.desc = "Manage App Forms";
forms.usage = "fh forms [list]\n" +
              "fh forms create <form-file.json>\n" +
              "fh forms update <form-file.json>\n" +
              "fh forms get <form-id>\n" +
              "fh forms export <form-id>\n" +
              "fh forms delete <form-id>\n" +
              "fh forms apps list\n" +
              "fh forms apps get <app-id>\n" +
              "fh forms apps update <app-id> <form-id>*\n" +
              "fh forms apps create <app-title> <theme-id> <form-id>*\n" +
              "fh forms formapps <form-id>\n" +
              "fh forms groups [list]\n" +
              "fh forms groups get <group-id>\n" +
              "fh forms groups update <group-id> <group-name> <user-id>* <form-id>* <app-id>* <theme-id>*   # user-id and form-id should be a comma-seperated list of values\n" +
              "fh forms groups create <group-name> <user-id>* <form-id>* <app-id>* <theme-id>*              # user-id and form-id should be a comma-seperated list of values\n" +
              "fh forms groups delete <group-id>\n" +
              "fh forms config get <app-id>\n" +
              "fh forms config create <app-id> <config-file.json>\n" +
              "fh forms config update <app-id> <config-file.json>\n" +
              "fh forms config delete <app-id>\n" +
              "fh forms notifications [list] <form-id>\n" +
              "fh forms notifications add <form-id> <email-address>\n" +
              "fh forms notifications delete <form-id> <email-address>\n" +
              "";
