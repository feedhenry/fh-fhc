...
devices.usage = "\nfh devices list"
              + "\nfh devices read <device-id>"
              + "\nfh devices update <device-id> <label>"
              + "\nfh devices enable <device-id> <true|false>"
              + "\nfh devices purgedata <device-id> <true|false>"
              + "\nfh devices listusers <device-id>"
              + "\nfh devices listapps <device-id>";
