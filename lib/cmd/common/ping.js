...
ping.usage = "fh ping <app-id> --env=<environment>";
ping.desc = "Ping a FeedHenry cloud app";
...
function pingApp(appId, deployTarget, cb) {
  common.doApiCall(fhreq.getFeedHenryUrl(), "box/srv/1.1/ide/" + fhc.curTarget + "/app/ping", {guid: appId, deploytarget: deployTarget}, "Error pinging app: ", function (err, data) {
