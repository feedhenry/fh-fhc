...
appinit.usage = "\nfh appinit <app-id> <app-key> [<params>]";
appinit.desc = "Makes a client app init call with the cloud";
...
appinit.completion = function (opts, cb) {
  ...
  // only complete for 3'rd param, i.e. 'fh appinit <tab>'
  if (argv.length === 2) {  
    common.getAppIds(cb);
  }
};
