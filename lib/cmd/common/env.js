...
env.desc = "Cloud app environment variables";
env.usage = "fh env create <app-guid> <var_name> [<var_value>] --env=<environment>"
          +"\nfh env update <app-guid> <var_id> [<new_var_name>] [<var_value>] --env=<environment>"
          +"\nfh env read <app-guid> <var_id> --env=<environment>"
          +"\nfh env list <app-guid> --env=<environment>"
          +"\nfh env listDeployed <app-guid> [includeSystemEnvironmentVariables] --env=<environment>"
          +"\nfh env unset <app-guid> <var_id> --env=<environment>"
          +"\nfh env delete <app-guid> <var_id>"
          +"\nfh env push <app-guid> --env=<environment>";
