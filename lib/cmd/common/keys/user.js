...
userkeys.desc = "Manage user API Keys";
userkeys.usage = "fh keys user [list]"
           + "\nfh keys user add <label>"
           + "\nfh keys user read <label>"
           + "\nfh keys user update <old-label> <new-label>"
           + "\nfh keys user delete <label>"
           + "\nfh keys user target [<label>]";
