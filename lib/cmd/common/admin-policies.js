...
policies.desc = "Operations on Auth Policies for connecting to 3rd party auth systems";
policies.usage = "\nfh policies list"
              +"\nfh policies create <policy-id> <policy-type> <config> [<check-user-exists>] [<check-user-approved>]"
              +"\nfh policies update <guid> <policy-id> <policy-type> <config> [<check-user-exists>] [<check-user-approved>]"
              ...
              +"\nfh policies delete <guid>"
              +"\nfh policies read <policy-id>"
              +"\nfh policies users <policy-id>"
              +"\nfh policies addusers <policy-guid> <user-id>*"
              +"\nfh policies removeusers <policy-guid> <user-id>*";
