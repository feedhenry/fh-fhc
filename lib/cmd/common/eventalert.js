...
eventalert.desc = "Manage alerts of a FeedHenry App";
eventalert.usage = "fh eventalert listOptions"
  + "\nfh eventalert create <appid> alertName categories=eventCategories severities=eventSeverities events=eventNames emails=emailAddresses --env=<environment>"
  + "\nfh eventalert clone <alertId>"
  + "\nfh eventalert delete <alertId>"
  + "\nfh eventalert list <appId>"
  + "\nfh eventalert read <alertId>"
  + "\nfh eventalert read <appid> alertName"
  + "\nfh eventalert update <alertId> alertName categories=eventCategories severities=eventSeverities events=eventNames emails=emailAddresses"
  + "\nFor the valid values for eventCategories, eventSeverities and eventNames, please run 'fh eventalert listOptions' to see the full list";
