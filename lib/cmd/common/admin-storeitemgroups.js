...
groups.desc = "Administer App Store Item Groups in the MAM App Store";
groups.usage = "\nfh storeitemgroups list"
              +"\nfh storeitemgroups create <group-name> <group-description>"
              +"\nfh storeitemgroups delete <group-guid>"
              +"\nfh storeitemgroups read <group-guid>"
              +"\nfh storeitemgroups readByName <group-name>"
              +"\nfh storeitemgroups update <group-guid> <group-name> <group-description>"
              +"\nfh storeitemgroups addusers <group-guid> <user-email>*"
              +"\nfh storeitemgroups removeusers <group-guid> <user-email>*"
              +"\nfh storeitemgroups addstoreitems <group-guid> <storeitem-id>*"
              +"\nfh storeitemgroups removestoreitems <group-guid> <storeitem-id>*";
