...
imports.desc = "Import a previously exported FeedHenry zipfile";
imports.usage = "\nfh import <feedhenry zip file>";
imports.usage_ngui = "\nfh import <project-id> <app-title> <app-template-type> [<zip-file> || <git-repo>]"
