...
appstore.usage = ""
  +"\nfh admin-appstore read"
  +"\nfh admin-appstore update <name> <description> <appid1,apppid2>"
  +"\nfh admin-appstore updatefield <fieldname> <fieldvalue>"
  +"\nfh admin-appstore listitems" +
  "\nfh admin-appstore additem <StoreItem Guid>" +
  "\nfh admin-appstore removeitem <StoreItem Guid>" +
  "\nfh admin-appstore listpolicies" +
  "\nfh admin-appstore addpolicy <policyid>" +
  "\nfh admin-appstore removepolicy <policyid>";
