...
resources.usage = "\n Resources across FeedHenry."
            +"\nfh resources cache flush --env=<environment>"
            +"\nfh resources cache set --env=<environment> --type=<percent|size> --value=<value>" + 
            +"\ne.g. fh resources cache flush --env=dev"
            +"\ne.g. fh resources cache set --type=percent --value=50 --env=dev"
            +"\ne.g. fh resources cache set --type=size --value=524288000 --env=live"
            +"\nTo set unlimited cache size, use 'fh cache set --type=size --value=-1'\n";
