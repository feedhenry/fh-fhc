...
themes.usage = "fh themes [list]\n" +
               "fh themes create <theme-file.json>\n" +
               "fh themes update <theme-file.json>\n" +
               "fh themes get <theme-id>\n" +
               "fh themes delete <theme-id>\n" +
               "fh themes app get <app-id>\n" +
               "fh themes app set <app-id> <theme-id>";
