...
auditlog.desc = "Audit logs for the MAM App Store";
auditlog.usage = "\nfh admin-auditlog listlogs [limit=<limit>] [storeItemGuid=<store item guid>] [storeItemBinaryType=<android|iphone>] [userId=<user guid>] [deviceId=<device guid>]";
