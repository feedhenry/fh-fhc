...
templates.desc = "App & Project Templates";
templates.usage = "\nfh templates [list]"
                + "\nfh templates [read] <template-id>"
                + "\nfh templates init <template-id>";

templates.usage_ngui = "\nfh templates apps [<template-id>]"
                     + "\nfh templates projects [<template-id>]"
                     + "\nfh templates services [<template-id>]";
