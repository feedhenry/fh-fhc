...
apps.desc = "Lists applications";
apps.usage = "\nfh apps";
apps.usage_ngui = "\nfh apps [list] <project-id>" +
                  "\nfh create <project-id> <app-title> [<template-id>]" +
                  "\nfh create <project-id> <app-title> <template-type> <git-repo> [<git-branch>]" +
                  "\nfh read <project-id> <app-id>" +
                  "\nfh update <project-id> <app-id> <property-name> <property-value>" +
                  "\nfh delete <project-id> <app-id>";
...
function oldApps(args, cb){
  ...
  var action = args[0];
  if (action === 'read') {
    return cb("The 'fh apps read' command is deprecated. Please use 'fh read' command instead.");
  }else if (action === 'create'){
    return cb("The 'fh apps create' command is deprecated. Please use 'fh create' command instead.");
  }else if (action === 'update'){
    return cb("The 'fh apps update' command is deprecated. Please use 'fh update' command instead.");
  }else if (action === 'delete'){
    return cb("The 'fh apps delete' command is deprecated. Please use 'fh delete' command instead.");
  } else if (action === 'ping'){
    return cb("The 'fh apps ping' command is deprecated. Please use 'fh ping' command instead.");
  } else{
