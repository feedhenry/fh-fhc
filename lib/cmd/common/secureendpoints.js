...
secureendpoints.usage =
               "\nfh secureendpoints [get] <app-id> --env=<environment>"
              +"\nfh secureendpoints set-default <app-id> <default> --env=<environment>"
              +"\nfh secureendpoints set-override <app-id> <endpoint> <security> --env=<environment>"
              +"\nfh secureendpoints remove-override <app-id> <endpoint> --env=<environment>"
              +"\nfh secureendpoints auditlog <app-id> --env=<environment>"
              +"\nwhere 'default' can be either 'https' or 'appapikey'"
              +"\nUse 'fh appendpoints' to list an Apps endpoints.";
