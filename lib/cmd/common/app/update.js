...
update.usage = "fh app update [project-id] <app-id> <property-name> <property-value>";
...
function setConfigProperty(appId, k, v, cb) {
  fhreq.POST(fhreq.getFeedHenryUrl(), "box/srv/1.1/ide/" + fhc.curTarget + "/app/setconfig", {guid: appId, key: k, value: v},  function (er, remoteData) {
    if (er) {
