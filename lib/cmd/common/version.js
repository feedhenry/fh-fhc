...
version.desc = "Version info about the FeedHenry instance we're connected to";
...
function version (argv, cb) {
  ...
  fhreq.GET(url, "box/srv/1.1/tst/version", function (err, remoteData, raw, response) {
    ...
    if (response.statusCode === 200) {
      ...
      version.message = "FeedHenry " + remoteData.Environment + " " + remoteData.Release;
