...
stage.desc = "Stage a cloud app";
stage.usage = "\nfh app stage <appId>"
						+ "\nfh app stage <appId> runtime=<node06|node08|node010>"
            + "\nfh app stage <appId> [approver] [comment] runtime=<node06|node08|node010>> --env=<environment> "
            +"\nfh app stage <appId> [number_of_instances] [approver] [comment] runtime=<node06|node08|node010> --env=<environment>"
