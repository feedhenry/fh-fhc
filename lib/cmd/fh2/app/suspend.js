...
suspend.desc = "Suspend a cloud application";
suspend.usage = "fh app suspend <app-id> [apptype] --env=<environment> (where 'apptype' is 'cloud' (default) or 'embed')" +
                "\ne.g. fh suspend 12345 cloud --env=dev";
