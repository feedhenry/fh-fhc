...
exports.createTableForDataSources = function(dataSources){
  var table = new Table({
    head: ['ID', 'Name', 'Service GUID', 'Service Name', 'Endpoint', 'Refresh Interval'],
    style: exports.style()
  });
  ...
  _.each(dataSources, function (dataSource) {
    table.push([dataSource._id, dataSource.name, dataSource.service.guid, dataSource.service.title, dataSource.endpoint, moment.duration(dataSource.refreshInterval, 'minutes').humanize()]);
  }, this);
...
exports.createTableForEnvDataSources = function(dataSources){
  var table = new Table({
    head: ['ID', 'Name', 'Service GUID', 'Service Name', 'Endpoint', 'Status', 'Error', 'Data Length', 'Last Refreshed'],
    style: exports.style()
  });
...
exports.createTableForEnvDataSourcesValidation = function(dataSources){
  var table = new Table({
    head: ['Name', 'Service GUID', 'Service Name', 'Endpoint', 'Valid', 'Message', 'Data Length'],
    style: exports.style()
  });
