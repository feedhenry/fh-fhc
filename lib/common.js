...
exports.createTableForServices = function (projects) {
  var table = new Table({
    head: ['ID', 'Title', 'No. Apps', 'Last Modified'],
    style: exports.style()
  });
  ...
  _.each(projects, function (project) {
    var numApps = project.apps ? project.apps.length : 0;
    table.push([ project.apps[0].guid, project.title, numApps, moment(project.sysModified).fromNow()]);
  }, this);
...
exports.createAppEnv = function (appId, varName, value, env, cb) {
  ...
  postEnv("create", params, i18n._("Error creating env var: "), cb);
};

exports.readAppEnv = function (appId, envVarId, envValue, cb) {
  postEnv("read", {appId: appId, envVarId: envVarId, env: envValue}, i18n._("Error reading env var: "), cb);
};
...
exports.updateAppEnv = function (appId, envVarId, varName, value, env, cb) {
  ...
  postEnv("update", params, i18n._("Error updating env var: "), cb);
};

exports.deleteAppEnv = function (appId, envVarId, envValue, cb) {
  postEnv("delete", {appId: appId, envVarId: envVarId, env: envValue}, i18n._("Error deleting env var: "), cb);
};

exports.listAppEnv = function (appId, env, cb) {
  postEnv("list", {appId: appId, env: env}, i18n._("Error listing env var: "), cb);
};

exports.unsetAppEnv = function (params, cb) {
  postEnv("unset", params, i18n._("Error unseting env var:"), cb);
};

exports.pushAppEnv = function (appId, env, cb) {
  postEnv("push", {appId: appId, env: env}, i18n._("Error pushing env vars:"), cb);
};

exports.listDeployedAppEnv = function (appId, env, cb) {
  postEnv("listDeployed", {appId: appId, env: env}, i18n._("Error listing deployed env vars:"), cb);
};
