...
function getProjectIds(cb) {
  listProjects(function (err, projects) {
    if (err) return cb(err);
    var ids = _.pluck(projects, 'guid');
    return cb(null, ids);
  });
}
...
function readApp(projectId, appId, cb) {
  if (projectId) {
    //box/api/projects/Ibn9oULIY0bJG7G4Cfh0rO9z/apps/Ibn9oH3-LHsv0p-PFL85OjwS
...
function maxField(collection, field) {
