...
exports.createTableForProjects = function(projects) {
  var table = new Table({
    head: ['Project ID', 'Title', 'Type', 'Last Modified'],
    style: exports.style()
  });

  _.each(projects, function(project) {
    table.push([project.guid, project.title, 'Project', moment(project.sysModified).fromNow()]);

    // Apps in Project
    _.each(project.apps, function(app){
      table.push(['  ' + app.guid, app.title, app.type, moment(app.sysModified).fromNow()]);
    }, this);
  }, this);
