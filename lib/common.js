...
exports.createTableForDataSources = function(dataSources){
  var table = new Table({
    head: ['Service ID', 'Service Name', 'Endpoint', 'Upd At'],
    style: exports.style()
  });
 ...
 * @param dataSource
 */
exports.createTableForEnvDataSourcesAuditLogs = function(dataSource){
  var table = new Table({
    head: ['Service ID', 'Service Name', 'Endpoint', 'Status', 'Error', 'Data Length', 'Data Hash', 'Refresh Timestamp'],
    style: exports.style()
  });

  _.each(dataSource.auditLogs || [], function (dsAuditLogEntry) {
