...
exports.createAppEnv= function(appId, env,name,value,cb) {
  postEnv("create", {appId:appId,env:env,name:name,value:value}, "Error creating env var: ", cb);
};

exports.readAppEnv= function(appId, envVarId,cb) {
  postEnv("read", {appId:appId,envVarId:envVarId}, "Error reading env var: ", cb);
};

exports.updateAppEnv= function(appId, envVarId,name,value,cb) {
  postEnv("update", {appId:appId,envVarId:envVarId,name:name,value:value}, "Error updating env var: ", cb);
};

exports.deleteAppEnv= function(appId, envVarId,cb) {
  postEnv("delete", {appId:appId,envVarId:envVarId}, "Error deleting env var: ", cb);
};
