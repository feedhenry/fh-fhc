...
exports.createTableForUsers = function(users) {
  ...
  _.each(users, function(user) {
    table.push([user.guid, user.fields.username, user.fields.email, getYesNoFromBoolean(user.fields.activated), getYesNoFromBoolean(user.fields.enabled), getYesNoFromBoolean(user.fields.blacklisted), (user.fields.lastLogin) ? moment(user.fields.lastLogin).fromNow(): '']);
  }, this);
...
exports.createTableForMbaasTargets = function(mbassTargets) {
  ...
  _.each(mbassTargets, function(mbaas) {
    ...
    if (mbaas.modified) {
      mod = moment(mbaas.modified).fromNow();
    }
