...
submissions.usage = "fhc submissions [list]\n" +
    "fhc submissions list project=<project-id> form=<form-id>\n" +
    ...
    "fhc submissions export file=<zip-file> project=<project-id> || form=<form-id>\n" +
...
function getAppFormIds(args, cb) {
    var formId, file, projectId;
    if (!args) return cb(null, projectId, formId, file);
    ...
    process.nextTick(function() {
        return cb(null, projectId, formId, file);
    });
}
