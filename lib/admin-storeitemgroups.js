...
groups.usage = "\nfhc storeitemgroups list"
              ...
              +"\nfhc storeitemgroups addapps <group-guid> <app-id>*"
              +"\nfhc storeitemgroups removeapps <group-guid> <app-id>*"
...
// list groups
function list(cb) {
  common.doApiCall(fhreq.getFeedHenryUrl(), "/box/srv/1.1/admin/storeitemgroup/list", {}, "Error listing groups: ", function(err, users){
...
function addapps(id, apps, cb) {  
  common.doApiCall(fhreq.getFeedHenryUrl(), "/box/srv/1.1/admin/storeitemgroup/addapps", {"guid": id, "apps": apps}, "Error adding apps: ", function(err, data){
    if(err) return cb(err);
    return cb(undefined, data);
  });
}
...
function removeapps(id, apps, cb) {  
  common.doApiCall(fhreq.getFeedHenryUrl(), "/box/srv/1.1/admin/storeitemgroup/removeapps", {"guid": id,  "apps": apps}, "Error removing apps: ", function(err, data){
    if(err) return cb(err);
    return cb(undefined, data);
  });
}
