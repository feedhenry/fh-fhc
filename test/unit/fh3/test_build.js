...
module.exports = {
  'test build --project --app --cloud_app --tag --environment --destination': function(cb) {
    command({project:'1a2b3c4d5e6f7g8e9f0a1b2c',app:'1a2b3c4d5e6f7g8e9f0a1b2d',cloud_app:'1a2b3c4d5e6f7g8e9f0a1b2e',tag:'1a2b3c4d5e6f7g8e9f0a1b2e', destination:'android' }, function(err) {
      assert.ok(err);
      return cb();
    });
  }
